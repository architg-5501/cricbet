                ...
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm md:menu-md dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li>
                            ...
                            <div className={activeIndex === 0 ? "active text-primary-content flex gap-1" : "flex gap-1"} onClick={() => { setActiveIndex(0); router.push('/'); }}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                                Home
                            </div>
                        </li>
                        <li>
                            <div className={activeIndex === 1 ? "active text-primary-content flex gap-1" : "flex gap-1"} onClick={() => { setActiveIndex(1); router.push('/matches'); }}>
            ...
            <div className="navbar-center  ml-8 hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    <li>
                        ...
                        <div className={activeIndex === 0 ? "active cursor-pointer w-24 flex gap-1 text-primary-content" : "w-24 flex gap-1 cursor-pointer"} onClick={() => { setActiveIndex(0); router.push('/'); }}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                            Home
                    ...
                    <li>
                        <div className={activeIndex === 1 ? "active cursor-pointer w-24 flex gap-1 text-primary-content" : "w-24 flex gap-1 cursor-pointer"} onClick={() => { setActiveIndex(1); router.push('/matches'); }}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            Matches
                        </div>
                    </li>
                ...
                <div className="dropdown dropdown-end ">
                    ...
                    <ul tabIndex={0} className="menu menu-sm md:menu-md gap-4 dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className="tooltip tooltip-left" data-tip={account != "" ? account : "Click here to connect!!"}>
                            ...
                            <div className="flex gap-1 cursor-pointer justify-between" onClick={onConnectWallet}>
                        ...
                        <li>
                            <div onClick={() => onProfileClick(account)} className="cursor-pointer justify-between">
                                Dashboard
                            </div>
                        </li>

                        <li><div className='cursor-pointer' onClick={onDisconnectWallet} >Logout</div></li>
